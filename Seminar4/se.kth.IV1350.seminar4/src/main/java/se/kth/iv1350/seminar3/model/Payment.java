 ...
 */
public class Payment implements AmountPaidObserver{
   ...
   //@Override
     ...
     */
    public void addAmountPaidObserver(AmountPaidObserver obs){
        amountPaidObserver.add(obs);
    }
    /**
     * The specified observer will be no longer be notified when this sale has been paid.
     ...
     */
    public void addAmountPaidObservers(List<AmountPaidObserver> observers){
        amountPaidObserver.addAll(observers);
    }
